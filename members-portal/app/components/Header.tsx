        ...
        <div className="hidden md:flex items-center gap-[72px]">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 w-56 bg-gray-800 border border-gray-700 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
              <Link href="/store/ai-writer" className="block px-4 py-3 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition rounded-t-lg">
                AI Humanizer
              </Link>
              <Link href="/store/infographics" className="block px-4 py-3 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition">
                Infographics Studio
              </Link>
              <Link href="/store/prompt-optimizer" className="block px-4 py-3 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition">
                Prompt Optimizer
              </Link>
              <div className="border-t border-gray-700 my-1"></div>
              <Link href="/store/custom-gpts" className="block px-4 py-3 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition">
                Custom GPTs
              </Link>
              <Link href="/store/projects" className="block px-4 py-3 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition rounded-b-lg">
                Projects
              </Link>
            </div>
          </div>
