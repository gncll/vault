        ...
        <div className="border border-gray-200 p-8 bg-gray-50">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-2">
              ...
              <a
                href={`https://chatgpt.com/?prompt=${encodeURIComponent(customizedPrompt)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="border border-gray-900 bg-gray-900 text-white px-4 py-2 text-sm hover:bg-gray-800 transition flex items-center gap-2"
              >
